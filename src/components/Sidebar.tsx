...
import { Home, Coins, MessageCircle, Menu, X, Map, ExternalLink } from 'lucide-react';
...
export const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { title: 'D-app Preview', icon: <ExternalLink className="w-5 h-5" />, path: 'https://chat-to-earn.vercel.app', external: true }
  ];
